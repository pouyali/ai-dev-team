...
export default function SeniorLayout({ children }: SeniorLayoutProps): JSX.Element {
  ...
  const navItems: NavItem[] = [
    ...
    { icon: <PlusCircle className="w-5 h-5" />, label: 'New Request', href: '/new-request' },
    { icon: <Clock className="w-5 h-5" />, label: 'My Requests', href: '/my-requests', badge: 1 },
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        <div className="flex flex-col h-full">
          ...
          {/* Emergency contact */}
          <div className="px-4 py-3 mx-3 mb-3 bg-red-50 rounded-xl">
            <div className="flex items-center gap-2 text-red-700">
              <Phone className="w-4 h-4" />
              <span className="text-sm font-medium">Emergency</span>
            </div>
            <p className="text-xs text-red-600 mt-1">Call 911 for emergencies</p>
          </div>
